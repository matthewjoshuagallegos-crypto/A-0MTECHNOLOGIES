(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))s(t);new MutationObserver(t=>{for(const n of t)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function i(t){const n={};return t.integrity&&(n.integrity=t.integrity),t.referrerPolicy&&(n.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?n.credentials="include":t.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(t){if(t.ep)return;t.ep=!0;const n=i(t);fetch(t.href,n)}})();class r{constructor(){this.state={kernel:"A21S30i19GP13",encryption:"AES-GCM-512",authLevel:"ROOT",tokens:12450,fileSystem:{}},console.log("A#0M KERNEL INITIALIZED [SECURE 512-BIT]")}static getInstance(){return r.instance||(r.instance=new r),r.instance}getState(){return{...this.state}}async processCommand(e){const i=e.trim().toLowerCase();if(i.includes("tokens"))return`System: Current Liquidity is ${this.state.tokens} A#0M Units.`;if(i==="clear"||i==="cls")return"SYSTEM_CLEAR";if(i==="build")return"SYSTEM_BUILD_START";if(i.includes("underwriting"))return"System: Copyright (c) 2026 A#0M Technologies. Underwritten by Proctor & Gamble. Certified FCC Compliant.";if(i.includes("who are you")||i.includes("status"))return"A#0M Framework v2026.4.18. Identity: Matthew Joshua Gallegos (Creator). Secure 512-bit Tunnel Active.";try{if(i.startsWith("open "))return`Switching portal to: ${i.split(" ")[1].toUpperCase()}`}catch{return"Kernel Panic: Command mapping failed."}return`A#0M > Command '${e}' not recognized in current session.`}}class l{constructor(e){this.terminalHistory=[],this.appRoot=document.getElementById(e)||document.body,this.appRoot.classList.add("a0m-native-surface"),this.kernel=r.getInstance(),this.renderBootScreen()}async renderBootScreen(){this.appRoot.innerHTML=`
        ...
        `;const e=["Hardware: Macintosh/Apple/Pixel/Microsoft Linked","Encryption: AES-512-GCM Handshake Active","Logic: FCC Compliance vA21S30i19GP13 Verified","Sync: Google HQ Joint Path Synchronized","Ready: A#0M Technologies Kernel Online"],i=document.getElementById("boot-logs"),s=document.getElementById("boot-percent");for(let t=0;t<e.length;t++){if(await this.wait(400),i){const n=document.createElement("div");n.innerText=`> ${e[t]}`,i.appendChild(n),i.scrollTop=i.scrollHeight}s&&(s.innerText=`${Math.round((t+1)/e.length*100)}%`)}await this.wait(500),this.init()}init(){this.renderLayout(),this.initTerminal()}renderLayout(){this.appRoot.innerHTML=`
